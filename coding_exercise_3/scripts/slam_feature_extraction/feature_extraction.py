...
class FeatureDetection:
    ...
    #distance of point to line written in the general form
    ...
    #if the two lines intersect, then we can use:
    ...
    def laser_points_data(self,data):
        self.LASERPOINTS = []
        if not data:
            pass
        else:
    ...
    def odr_fit(self,laser_points):
        ...
        #create a real data object using our initiated dataf from above
        data = RealData(x,y)

        #set the ODR with the model and data
    ...
    def seed_segment_growing(self,indices,break_point):
        ...
        #beginning final and end points in the line segments
